...
При любом изменении `backend/app/models/*.py` — сначала создать файл миграции, потом коммит. Подробности и шаблон: [docs/migrations-rule.md](docs/migrations-rule.md).
