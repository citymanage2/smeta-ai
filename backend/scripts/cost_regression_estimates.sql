...
\echo ''
\echo '=== 6. Оценка неучтённой платы за web search ($10 / 1000 поисков) ==='
-- Плата за поиск в cost_usd не входит вообще. Число поисков на вызов неизвестно —
-- даём вилку 2/4/6 поисков на вызов по вызовам смет.
WITH c AS (
...
\echo ''
\echo 'Дальше: сумму logged_usd за период сравнить с фактическим списанием у посредника.'
\echo 'Отношение факт / logged = коэффициент, в который входят наценка, web search,'
\echo 'неуспешные вызовы и непрокинутая batch-скидка.'
